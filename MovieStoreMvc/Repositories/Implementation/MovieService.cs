    ...
    public class MovieService : IMovieService
    {
        ...
        public bool Update(Movie model)
        {
            try
            {
                ...
                // these genreIds are not selected by users and still persent is movieGenre table corresponding to 
                // this movieId. So these ids should be removed.
                var genresToDelected = ctx.MovieGenre.Where(a => a.MovieId == model.Id && !model.Genres.Contains(a.GenreId)).ToList();
                foreach(var mGenre in genresToDelected) 
                {
